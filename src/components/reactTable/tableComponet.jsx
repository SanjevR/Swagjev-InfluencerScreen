...
export default function TableComponent({columnProps, tableData, setTableData, editButtons, features, crudFns, title, idProperty, subtotalColumns}) {
    ...
    console.log("tableComponent", title)
    ...
    const handleOnSave = () => {
        ...
        const updatedData = {
            ...tableData.find((row) => row[idProperty] === editingRowId),
            ...editValues[editingRowId],
        };


        crudFns({
            id: editingRowId, action: "edit", idProperty: idProperty,
    ...
    const calculateTotals = (tableData, columns) => {
        const totals = {};
        ...
        columns.forEach(column => {
            if (subtotalColumns.includes(column.accessor)) {
                ...
                const columnValues = tableData.map(row => {
    ...
    const totals = calculateTotals(tableData, columns);
